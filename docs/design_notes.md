...
**Plan de alertas**:
- Tasa de rechazo > 5% → notificación al equipo de datos por Slack o email
- `filas_fact_order = 0` o proceso terminado con error → alerta crítica con llamada on-call
- Duración > 300s → revisión de volumen o cuellos de botella en transformaciones
